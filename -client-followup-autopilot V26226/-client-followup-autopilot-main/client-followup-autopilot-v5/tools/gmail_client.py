...
def _build_message(to, subject, body_html, cc=None, thread_id=None, from_email=None):
...
def create_draft(to, subject, body_html, cc=None, thread_id=None, from_email=None):
    """
