...
# ─── Follow-Up Schedule (days after initial due date) ────────────────────────
FOLLOWUP_SCHEDULE = {
    1: 0,   # Stage 1: Day 0 (on due date or immediately if overdue)
    2: 3,   # Stage 2: 3 days after Stage 1
    3: 7,   # Stage 3: 4 days after Stage 2 (7 total)
    4: 14,  # Stage 4: 7 days after Stage 3 (14 total)
}
